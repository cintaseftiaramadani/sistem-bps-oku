...
@section('content')
    ...
    <a href="{{ route('menu_akun') }}" class="btn p-2 mb-1" style="color: gray; font-size: 1.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="mb-1">Akun Belanja Perjalanan Dinas Biasa</h3>
                <small style="font-size: 14px;">(524111) : - </small>
            </div>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', () => {
                const pdfPath = encodeURI('/dokumen_lubaca/pdf/akun_belanja_perjalanan_dinas_biasa.pdf');
            ...
            <table class="table table-bordered table-sm text-sm" style="border: 1px solid #ddd;">
                ...
                <tbody style="font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="{{ asset('dokumen_lubaca/SK KPA tentang.docx') }}" download class="text-decoration-underline">SK KPA tentang honor/ Surat Tugas</a>
                        </td>
                        <td class="text-center">√</td>
                        <td class="text-center">√</td>
                        <td class="text-center">√</td>
