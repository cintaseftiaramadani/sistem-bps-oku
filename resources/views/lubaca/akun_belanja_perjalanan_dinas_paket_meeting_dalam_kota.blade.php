...
@section('content')
    ...
    <a href="{{ route('menu_akun') }}" class="btn p-2 mb-1" style="color: gray; font-size: 1.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="mb-1">Akun Belanja Perjalanan Dinas Paket Meeting Dalam Kota</h3>
                <small style="font-size: 14px;">(524114) : - </small>
            </div>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', () => {
                const pdfPath = encodeURI('/dokumen_lubaca/pdf/akun_belanja_paket_meeting_dalam_kota.pdf');
