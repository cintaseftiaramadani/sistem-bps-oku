...
@section('content')
    ...
    <a href="{{ route('menu_akun') }}" class="btn p-2 mb-1" style="color: gray; font-size: 1.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="mb-1">Akun Belanja Sewa</h3>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', () => {
                const pdfPath = encodeURI('/dokumen_lubaca/pdf/akun_belanja_sewa.pdf');
            ...
            <table class="table table-bordered table-sm text-sm" style="border: 1px solid #ddd;">
                ...
                <tbody style="font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="{{ asset('dokumen_lubaca/SK KPA tentang honor Surat Tugas.docx') }}" download class="text-decoration-underline">SK KPA tentang honor/ Surat Tugas</a>
                        </td>
                        <td class="text-center">√</td>
                        <td class="text-center">√</td>
                        <td class="text-center">√</td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd;"> 
                            <a href="{{ asset('dokumen_lubaca/Laporan Pelatihan Sudah Upload.docx') }}" download class="text-decoration-underline">Laporan Pelatihan Sudah Upload</a>
                        </td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd;">  
                            <a href="{{ asset('dokumen_lubaca/Dokumentasi Pencacahan Sudah Upload.docx') }}" download class="text-decoration-underline">Dokumentasi Pencacahan Sudah Upload</a>
                        </td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd;">
                            <a href="{{ asset('dokumen_lubaca/Dokumentasi Supervisi Sudah Upload.docx') }}" download class="text-decoration-underline">Dokumentasi Supervisi Sudah Upload</a>
                        </td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
