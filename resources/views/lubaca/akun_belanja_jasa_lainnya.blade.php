...
@section('content')
    ...
    <a href="{{ route('menu_akun') }}" class="btn p-2 mb-1" style="color: gray; font-size: 1.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="mb-1">  Akun Belanja Jasa Lainnya</h3>
                <small style="font-size: 14px;">(522191) : - </small>
            </div>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', () => {
                const pdfPath = encodeURI('/dokumen_lubaca/pdf/akun_belanja_jasa_lainnya.pdf');
            ...
            <table class="table table-bordered table-sm text-sm" style="border: 1px solid #ddd;">
                ...
                <tbody style="font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd;">
                            <a href="{{ asset('dokumen_lubaca/BAST Penyelesaian pekerjaann.docx') }}" download class="text-decoration-underline">BAST Penyelesaian pekerjaann</a>
                        </td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">-</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
