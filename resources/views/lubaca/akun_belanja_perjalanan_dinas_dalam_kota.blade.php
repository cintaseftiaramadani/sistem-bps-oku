...
@section('content')
    ...
    <a href="{{ route('menu_akun') }}" class="btn p-2 mb-1" style="color: gray; font-size: 1.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="mb-1">Akun Belanja Perjalanan Dinas Dalam Kota </h3>
                <small style="font-size: 14px;">(524113) : - </small>
            </div>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', () => {
                const pdfPath = encodeURI('/dokumen_lubaca/pdf/akun_belanja_perjalanan_dinas_dalam_kota.pdf');
            ...
            <table class="table table-bordered table-sm text-sm" style="border: 1px solid #ddd;">
                ...
                <tbody style="font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="{{ asset('dokumen_lubaca/Laporan innas/Inda.docx') }}" download class="text-decoration-underline">Laporan innas/Inda</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd;">
                            <a href="{{ asset('dokumen_lubaca/SSP PPh Pasal 21.docx') }}" download class="text-decoration-underline">SSP PPh Pasal 22</a>
                        </td>    
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
                        <td class="text-center" style="border: 1px solid #ddd;">√</td>
